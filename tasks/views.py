...
def signup(request):
    ...
    if request.method == "GET":
        ...
        if request.POST["password1"] == request.POST["password2"]:
            ...
            try:
                ...
                return render(
                    request,
                    "signup.html",
                    {"form": UserCreationForm, "message": "Username already exists"},
                )
        ...
        return render(
            request,
            "signup.html",
            {"form": UserCreationForm, "message": "Password do not match"},
        )
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return render(
                request,
                "created_task.html",
                {"form": TaskForm, "message": "Error occured while creating task"},
            )
...
#     # Esto generará un error de división por cero
#     division_by_zero = 1 / 0
#     return HttpResponse("Esta línea nunca se ejecutará")
